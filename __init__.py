...
- missing root index navigation is generated by the configured LLM; existing index is reused
...
WIKI_TOOL_SCHEMA = {
    ...
    "description": (
        ...
        "write (create/update a page - log updates automatically; missing "
        "navigation may be generated), "
